...
<div style="padding: 24px ; border: 2px solid #1776BF; border-radius: 4px; margin-bottom: 24px; background-color: #f6fafe ">
  ...
  <p class="lead" style="font-size:22px"> The release notes for {{< product-c8y-iot >}} Streaming Analytics have been moved to a new <a href="https://{{< domain-c8y >}}/releasenotes/about">release notes page</a>:</p>
