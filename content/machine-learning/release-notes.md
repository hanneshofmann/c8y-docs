...
<div style="padding: 24px ; border: 2px solid #1776BF; border-radius: 4px; margin-bottom: 24px; background-color: #f6fafe ">
  ...
  <p class="lead" style="font-size:22px"> The release notes for {{< product-c8y-iot >}} Machine Learning have been moved to a new <a href="https://{{< domain-c8y >}}/releasenotes/about">release notes page</a>:</p>

![Release notes page](/images/release-notes/release-notes-overview.png)

<p style="font-size:16px">On this new page, select a release version from the dropdown on the left and navigate to the Machine Learning entry in the index.</p>
